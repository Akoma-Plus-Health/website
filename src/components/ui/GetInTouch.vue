<template>
    <div class="bg-[#590000] py-32">
        <div class="container mx-auto max-w-2xl text-center">
            <h2 class="mb-4 text-2xl font-bold text-white md:mb-6 lg:text-4xl">Let's Get In Touch</h2>

            <p class=" text-white text-lg">To find out more about our
                services,
